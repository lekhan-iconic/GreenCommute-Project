...
const BicycleForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:3000/bookingbicycle", {
        name,
        mobile,
        pickuploc,
        destinationloc,
  ...
  return (
    <>
      ...
      <h1 className="text-center fs-20 fw-bold">Byclye Ride Booking</h1>
      ...
      <Container>
        ...
        <ImageContainer>
          <Image src="bike.jpg" alt="Car Images" />
        </ImageContainer>
      </Container>
    </>
  );
