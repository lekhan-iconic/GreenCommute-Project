...
const BikeForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:3000/bookingbike", {
        name,
        mobile,
        pickuploc,
        destinationloc,
  ...
  return (
    <>
      ...
      <h1 className="text-center fs-20 fw-bold">Bike Ride Booking</h1>
      ...
      <Container>
        ...
        <ImageContainer>
          <Image
            src="electric-motorcycle-icon-free-vector.jpg"
            alt="Car Images"
          />
        </ImageContainer>
      </Container>
