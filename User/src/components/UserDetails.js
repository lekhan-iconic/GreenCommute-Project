  ...
  return (
    <div>
      ...
      <div className="container mt-5 user-details">
        <h1 className="mb-4 animate_animated animate_fadeInDown">My Profile</h1>
        <div className="row">
          <div className="col-md-4 animate_animated animate_fadeInLeft">
          ...
          <div className="col-md-8 animate_animated animate_fadeInRight">
        ...
        <div className="row mt-3">
          <div className="col-md-12 animate_animated animate_fadeInUp">
